    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-10 px-4 max-w-screen-xl mx-auto space-y-12">
        ...
        <motion.section
          className=""
        >
          <h2 className="cormorant text-2xl mb-6">Your Skin Profile</h2>
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-[#FDF8F6] p-6 rounded-[30px] flex flex-col items-center">
              <div className="text-4xl mb-3">✨</div>
              <div className="text-lg font-medium text-[#3E2723] mb-1">피부 타입</div>
              <div className="text-[#3E2723]/70">{quizResults?.skinType || 'Normal'}</div>
            </div>
            <div className="bg-[#FDF8F6] p-6 rounded-[30px] flex flex-col items-center">
              <div className="text-4xl mb-3">🎯</div>
              <div className="text-lg font-medium text-[#3E2723] mb-1">피부 나이</div>
              <div className="text-[#3E2723]/70">28세</div>
            </div>
          </div>

          <div className="bg-[#FDF8F6] p-6 rounded-[30px] mb-8">
            <div className="flex items-center mb-4">
              <span className="text-2xl mr-2">🔍</span>
              <h3 className="text-lg font-medium text-[#3E2723]">주요 피부 고민</h3>
            </div>
            <div className="grid grid-cols-2 gap-3">
              {(quizResults?.concerns || []).slice(0, 4).map((concern, index) => (
                <div key={index} className="bg-white p-3 rounded-[20px] text-center text-[#3E2723]/70">
                  {concern}
                </div>
              ))}
            </div>
          ...
          <div className="bg-[#FDF8F6] p-6 rounded-[30px]">
            <div className="flex items-center mb-4">
              <span className="text-2xl mr-2">💫</span>
              <h3 className="text-lg font-medium text-[#3E2723]">피부 상태</h3>
            </div>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-[#3E2723]/70">수분</span>
                <div className="w-2/3 bg-white rounded-full h-2">
                  <div className="bg-[#3E2723] h-full rounded-full" style={{ width: '70%' }}></div>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[#3E2723]/70">탄력</span>
                <div className="w-2/3 bg-white rounded-full h-2">
                  <div className="bg-[#3E2723] h-full rounded-full" style={{ width: '65%' }}></div>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[#3E2723]/70">민감도</span>
                <div className="w-2/3 bg-white rounded-full h-2">
                  <div className="bg-[#3E2723] h-full rounded-full" style={{ width: '45%' }}></div>
                </div>
              </div>
            </div>
          </div>
