...
const QuizIntro = ({ onStartQuiz }) => {
  return (
    ...
    >
      <ScrollToTop />
      <div className="flex-1 max-w-4xl mx-auto px-6 pt-10 pb-12 flex flex-col justify-between">
            ...
            >
              <div className="flex flex-col items-center text-center space-y-2 md:space-y-3">
                ...
                <div>
                  ...
                  <div className="text-xs md:text-sm text-[#3E2723]/60">{item.description}</div>
                </div>
              </div>
            </motion.div>
          ))}
