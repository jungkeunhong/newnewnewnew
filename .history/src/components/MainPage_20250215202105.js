        ...
        >
          ...
          <div className="flex justify-between">
            <div className="text-center">
              ...
              <div className="text-sm font-medium">Skin Age</div>
              <div className="text-2xl font-bold text-[#3E2723]">27</div>
            </div>
            <div className="text-center">
              <div className="text-2xl mb-1">💧</div>
              <div className="text-sm font-medium">Hydration</div>
              <div className="text-2xl font-bold text-[#3E2723]">8.5</div>
            </div>
            <div className="text-center">
              <div className="text-2xl mb-1">✨</div>
              <div className="text-sm font-medium">Elasticity</div>
              <div className="text-2xl font-bold text-[#3E2723]">7.8</div>
            </div>
            <div className="text-center">
              <div className="text-2xl mb-1">🎯</div>
              <div className="text-sm font-medium">Texture</div>
              <div className="text-2xl font-bold text-[#3E2723]">8.2</div>
            </div>
          </div>
            ...
            {treatments.map((treatment, index) => (
              ...
              >
                <div className="p-3 flex flex-col items-center text-center">
                  <div className="w-20 h-20 mb-2 relative rounded-full overflow-hidden border-2 border-[#3E2723]/10">
                    <img 
                      src={treatment.image} 
                      alt={treatment.name}
                  ...
                  <div className="flex-1 w-full">
                    <h3 className="font-medium text-xl mb-1">{treatment.name}</h3>
