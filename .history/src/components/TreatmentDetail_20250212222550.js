  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-10 px-4 max-w-screen-xl mx-auto space-y-12">
        ...
        >
          <h2 className="cormorant text-2xl">시술 장점</h2>
        ...
        >
          <h2 className="cormorant text-2xl">시술 전 주의사항</h2>
          <div className="prose-like space-y-4 text-[#3E2723]/80">
            <p>시술 전 다음 사항들을 확인해주세요:</p>
            <ul className="list-disc list-inside space-y-2">
              <li>시술 전 24시간 동안 음주를 피해주세요</li>
              <li>시술 부위 화장은 피해주세요</li>
              <li>임신 중이거나 수유 중인 경우 반드시 상담해주세요</li>
              <li>항응고제를 복용 중인 경우 의사와 상담해주세요</li>
              <li>최근 2주 내 다른 시술을 받은 경우 알려주세요</li>
            </ul>
          </div>
        </motion.section>
