  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-10 px-4 max-w-screen-xl mx-auto space-y-12">
        ...
        >
          <h2 className="cormorant text-2xl mb-4">Your Unique Skin Profile</h2>
        ...
        >
          ...
          <p className="text-[#3E2723]/80 leading-relaxed mb-6">
            {quizResults?.skinType === 'Combination' 
              ...
              : 'Get a expert level skin alaysis. You can get personalized care based on deep analysis on you.'}
          </p>
          <button
