    ...
    >
      <div className="p-4 space-y-6">
        ...
        <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-6 shadow-sm border border-pink-100 space-y-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex items-center gap-2">
                <motion.button
                  className="flex-[3] bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 px-4 rounded-lg flex items-center justify-center space-x-2"
                ...
                <motion.button
                  className="flex-1 p-2 border border-purple-200 rounded-lg"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-purple-900">Key Ingredients</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-purple-900">How to Use</h2>
