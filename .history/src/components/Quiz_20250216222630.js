        ...
        {questions.map((question) => (
          <div key={question.id} className="mb-8">
            ...
            <div className="overflow-x-auto">
              <div className={`grid ${question.id === 'concerns' || question.id === 'goals' 
                ? 'grid-rows-2 auto-cols-max grid-flow-col' 
                : 'grid-cols-auto-fit'} gap-2 min-w-min pb-2`}>
                {question.options.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-sm inline-block transition-all
                        ${isSelected 
