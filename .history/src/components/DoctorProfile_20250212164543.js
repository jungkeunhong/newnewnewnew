    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-luxe-600 mb-2">
              Select Treatment
            </label>
          ...
          <motion.button
            className="w-full p-4 bg-gradient-to-r from-luxe-400 to-luxe-300 text-white rounded-xl mt-4"
