      ...
      <div className="w-full max-w-md space-y-8 text-center">
        ...
        >
          <div className="flex items-center justify-center space-x-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-luxe-100 to-luxe-50 shadow-lg border border-luxe-200/50 flex items-center justify-center transform hover:scale-105 transition-all">
      ...
      {showMessage && (
        ...
        >
          <p className="text-center text-luxe-500">
            {user ? "📸 Select and take a close-up photo of your concern area (forehead, nose, cheeks, etc.)" : "Please sign in to analyze your skin 🔒"}
          </p>
        </motion.div>
      )}
