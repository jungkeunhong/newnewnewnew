      ...
      <div className="p-4 space-y-6">
        ...
        <div className="space-y-4 divide-y divide-gray-400">
          {doctors.map((doctor) => (
            <motion.div
              key={doctor.id}
              className="bg-white p-4 first:pt-0 hover:shadow-lg transition-shadow cursor-pointer relative"
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="absolute bottom-4 right-4 w-6 h-6 rounded-full bg-luxe-50 flex items-center justify-center">
