    ...
    filler: [
      {
        ...
        clinic: "JK Plastic Surgery",
        rating: 4.8,
        reviews: 'https://www.google.com/maps/search/?api=1&query=JK+Plastic+Surgery+New+York',
        image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=500",
        expertise: ["Fillers", "Facial Contouring", "Non-surgical Procedures"],
        education: [
          "MD, Yale School of Medicine",
          "Residency: Plastic Surgery, NYU Langone",
          "Fellowship: Aesthetic Surgery, Manhattan Eye, Ear & Throat Hospital"
        ],
        intro: "Dr. Kim is renowned for his artistic approach to facial aesthetics and his commitment to natural-looking results. His expertise in facial anatomy and advanced injection techniques ensures optimal outcomes for his patients.",
        languages: ["English", "Korean"],
        location: "New York, NY",
        website: "https://jkplasticsurgery.com",
        treatments: [
          {
            name: "Dermal Fillers",
            description: "Premium hyaluronic acid fillers for natural-looking volume enhancement and facial contouring",
            time: "30-45 minutes",
    ...
    microneedling: [
      {
        ...
        clinic: "Pure Dermatology",
        rating: 4.7,
        reviews: 'https://www.google.com/maps/search/?api=1&query=Pure+Dermatology+New+York',
        image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=500",
        expertise: ["Microneedling", "Chemical Peels", "Laser Treatments"],
        education: [
          "MD, Stanford University School of Medicine",
          "Residency: Dermatology, UCSF",
          "Fellowship: Cosmetic Dermatology, Harvard Medical School"
        ],
        intro: "Dr. Chen specializes in combining traditional dermatology with cutting-edge aesthetic treatments. Her expertise in skin rejuvenation has made her a sought-after specialist in the field of cosmetic dermatology.",
        languages: ["English", "Mandarin"],
        location: "New York, NY",
        website: "https://puredermatology.com",
        treatments: [
          {
            name: "RF Microneedling",
            description: "Advanced treatment combining microneedling with radiofrequency energy for enhanced collagen production and skin tightening",
            time: "45-60 minutes",
