    ...
    const questions = [
      {
        ...
        options: ["건성", "지성", "복합성", "중성", "민감성"]
      },
      {
        id: 2,
        question: "현재 가장 큰 피부 고민은 무엇인가요?",
        options: ["여드름", "색소침착", "주름", "모공", "건조함"]
      },
      {
        id: 3,
        question: "선호하는 스킨케어 제품 타입은?",
        options: ["크림타입", "젤타입", "에센스타입", "오일타입", "로션타입"]
      },
      {
        id: 4,
        question: "하루에 스킨케어에 투자하는 시간은?",
        options: ["5분 이하", "5-10분", "10-20분", "20-30분", "30분 이상"]
      },
      {
        id: 5,
        question: "메이크업을 얼마나 자주 하시나요?",
        options: ["매일", "주 3-4회", "주 1-2회", "거의 안함", "전혀 안함"]
      }
    ];
