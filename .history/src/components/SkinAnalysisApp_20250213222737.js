...
const SkinAnalysisApp = () => {
  ...
  const handleBackToResultsDetailedAnalysisDoctorProfile = navigateTo('detailed', { resetDoctor: true });
  ...
  const handleBackToResultsDetailedAnalysisDoctorProfile = () => navigate('detailed', { selectedDoctor: null });
...
const SkinAnalysisApp = () => {
  ...
  // 복합 네비게이션 핸들러들
  const handleBackToResultsDetailedAnalysis = () => navigate('detailed');
  const handleBackToResultsDetailedAnalysisDoctorProfile = () => navigate('detailed', { resetDoctor: true });
...
const SkinAnalysisApp = () => {
  ...
  const handleBackToResultsDetailedAnalysisDoctorProfile = () => handleNavigation('detailed', { selectedDoctor: null });
