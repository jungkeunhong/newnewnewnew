...
const MainPage = ({ quizResults, onStartAnalysis, onTreatmentClick, onBack, onDoctorClick }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-10 px-4 max-w-screen-xl mx-auto divide-y divide-[#3E2723]/40">
        {/* Survey Summary */}
        ...
        <motion.section className="pt-4 pb-12">
          <h2 className="pt-4 cormorant text-2xl">See treatments for your concern</h2>
        ...
        <motion.section className="pt-12">
          ...
          <div className="divide-y divide-[#3E2723]/40">
            {treatments.map((treatment, index) => (
              <div 
                key={index} 
              ...
              >
                ...
                <p className="text-m text-[#3E2723]/80 mb-3">
