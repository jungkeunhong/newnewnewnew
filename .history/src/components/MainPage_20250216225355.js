...
const MainPage = ({ quizResults, onStartAnalysis, onTreatmentClick, onBack, onDoctorClick }) => {
  ...
  const getSkinSummary = () => {
    ...
    return `Your skin analysis shows opportunities for improvement in ${concernsList}. With targeted treatments, we can help you achieve optimal skin health.`;
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-10 px-4 max-w-screen-xl mx-auto">
        ...
        <motion.section className="pb-12 border-b border-[#3E2723]/10">
          ...
          <p className="text-[#3E2723]/80 text-lg font-light leading-relaxed mb-8">
            {getSkinSummary()}
          </p>
          ...
          <div className="space-y-6">
            <div className="border-b border-[#3E2723]/10 pb-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-[#3E2723] mb-1">Hydration Balance</h3>
            ...
            <div className="border-b border-[#3E2723]/10 pb-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-[#3E2723] mb-1">Surface Texture</h3>
            ...
            <div className="pb-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-[#3E2723] mb-1">Skin Resilience</h3>
        ...
        <motion.section className="pt-12">
          ...
          <div className="divide-y divide-[#3E2723]/10">
            {treatments.map((treatment, index) => (
              <div 
                key={index} 
                className="py-6 hover:bg-[#3E2723]/5 transition-all cursor-pointer"
