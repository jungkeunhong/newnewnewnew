    ...
    >
      ...
      <div className="flex-1 max-w-4xl mx-auto px-6 pt-20 pb-12 flex flex-col justify-between">
        <div className="space-y-6 text-center">
          <h1 className="cormorant text-4xl md:text-5xl font-light text-[#3E2723] leading-tight">
          ...
          {[
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                <item.icon className="w-6 h-6 text-[#3E2723]/80" />
                <div>
                  <div className="text-sm font-medium text-[#3E2723]">{item.title}</div>
                  <div className="text-xs text-[#3E2723]/60">{item.description}</div>
                </div>
              </div>
            </motion.div>
          ))}
