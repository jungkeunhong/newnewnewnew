        ...
        >
          ...
          <div className="space-y-4">
            {treatments.map((treatment, index) => (
              <motion.button
                key={treatment.id}
                className="w-full bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow p-6"
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-40 h-40 mb-4 relative">
                    <div className="absolute inset-0 rounded-full border-2 border-[#3E2723]/10 shadow-[0_0_20px_rgba(62,39,35,0.1)]" />
                    <img 
                      src={treatment.image} 
                      alt={treatment.name}
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col items-center">
                      ...
                      <ChevronRight className="w-5 h-5 text-[#3E2723]/40 mt-3" />
                    </div>
                  </div>
                </div>
              </motion.button>
