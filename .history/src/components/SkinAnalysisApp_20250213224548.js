...
const SkinAnalysisApp = () => {
  ...
  const navigationHandlers = {
    backToResults: () => navigate('results'),
    backToDetailedAnalysis: () => navigate('detailedAnalysis'),
    backToDoctor: () => navigate('doctor'),
    backToProduct: () => navigate('product'),
    backToSearch: () => navigate('search', { tab: 'search' }),
    backToHome: () => navigate('home'),
    backToLanding: () => navigate('landing'),
    backToQuizIntro: () => navigate('quiz-intro'),
    backToQuiz: () => navigate('quiz'),
    backToMain: () => navigate('main'),
    backToUpload: () => navigate('upload'),
    backToProfile: () => navigate('profile'),
    backToSettings: () => navigate('settings'),
    backToHelp: () => navigate('help'),
    backToAbout: () => navigate('about'),
    backToCommunity: () => navigate('community', { tab: 'community' }),
    backToPost: () => navigate('post', { tab: 'post' }),
    backToMyPage: () => navigate('myPage', { tab: 'my-page' }),
    backToResultsDetailedAnalysis: () => navigate('detailed'),
    backToResultsDetailedAnalysisProduct: () => navigate('detailed', { selectedProduct: null }),
    backToResultsDetailedAnalysisSearch: () => navigate('results', { currentTab: 'search' }),
    backToResultsDetailedAnalysisCommunity: () => navigate('results', { currentTab: 'community' }),
    backToResultsDetailedAnalysisPost: () => navigate('results', { currentTab: 'post' }),
    backToResultsDetailedAnalysisMyPage: () => navigate('results', { currentTab: 'my-page' })
  };

  // 네비게이션 핸들러 사용 예시
  const handleBackToResults = navigationHandlers.backToResults;
  const handleBackToDetailedAnalysis = navigationHandlers.backToDetailedAnalysis;
  const handleBackToDoctor = navigationHandlers.backToDoctor;
  const handleBackToProduct = navigationHandlers.backToProduct;
  const handleBackToSearch = navigationHandlers.backToSearch;
  const handleBackToHome = navigationHandlers.backToHome;
  ...
  const handleBackToLanding = navigationHandlers.backToLanding;
  const handleBackToQuizIntro = navigationHandlers.backToQuizIntro;
  const handleBackToQuiz = navigationHandlers.backToQuiz;
  const handleBackToMain = navigationHandlers.backToMain;
  const handleBackToUpload = navigationHandlers.backToUpload;
  const handleBackToProfile = navigationHandlers.backToProfile;
  const handleBackToSettings = navigationHandlers.backToSettings;
  const handleBackToHelp = navigationHandlers.backToHelp;
  const handleBackToAbout = navigationHandlers.backToAbout;
  const handleBackToCommunity = navigationHandlers.backToCommunity;
  const handleBackToPost = navigationHandlers.backToPost;
  const handleBackToMyPage = navigationHandlers.backToMyPage;

  const handleBackToResultsDetailedAnalysis = navigationHandlers.backToResultsDetailedAnalysis;
  const handleBackToResultsDetailedAnalysisProduct = navigationHandlers.backToResultsDetailedAnalysisProduct;
  const handleBackToResultsDetailedAnalysisSearch = navigationHandlers.backToResultsDetailedAnalysisSearch;
  const handleBackToResultsDetailedAnalysisCommunity = navigationHandlers.backToResultsDetailedAnalysisCommunity;
  const handleBackToResultsDetailedAnalysisPost = navigationHandlers.backToResultsDetailedAnalysisPost;
  const handleBackToResultsDetailedAnalysisMyPage = navigationHandlers.backToResultsDetailedAnalysisMyPage;
  ...
  return (
    <div className="min-h-screen bg-white">
      <AnimatePresence>
        ...
        {step === 'detailed' && <DetailedAnalysis />}
        {step === 'doctor' && <DoctorProfile />}
        {step === 'product' && <ProductDetail />}
        {step === 'search' && <SearchScreen />}
        {step === 'landing' && <LandingPage />}
        {step === 'quiz-intro' && <QuizIntro />}
        {step === 'quiz' && <Quiz />}
        {step === 'main' && <MainPage />}
      </AnimatePresence>
