    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-10 px-4 max-w-screen-xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            <div className="flex justify-between">
              <div className="text-center flex-1">
                ...
                <div className="text-lg font-medium text-[#3E2723]">Moderate</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-2xl mb-1">🔍</div>
                <div className="text-sm font-medium text-[#3E2723]/80">Texture</div>
                <div className="text-lg font-medium text-[#3E2723]">Balanced</div>
              </div>
              <div className="text-center flex-1">
                <div className="text-2xl mb-1">🌅</div>
                <div className="text-sm font-medium text-[#3E2723]/80">Glow Potential</div>
                <div className="text-lg font-medium text-[#3E2723]">High</div>
              </div>
            </div>

            <div className="mt-6 p-4 bg-[#3E2723]/5 rounded-xl">
              <div className="flex items-start">
                <span className="text-xl mr-2">👉</span>
                <div>
                  <div className="text-sm font-medium text-[#3E2723]/80">Next Step</div>
                  <div className="text-base text-[#3E2723]">
                    Explore treatments for under-eye care & hydration
                  </div>
                </div>
              </div>
            </div>
        ...
        <motion.section
          className="space-y-6"
        >
          <h2 className="cormorant text-2xl">See personalized treatments for your skin concern</h2>
