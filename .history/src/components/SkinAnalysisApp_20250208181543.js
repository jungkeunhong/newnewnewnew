  ...
  const SearchScreen = () => (
    ...
    >
      <div className="p-4 space-y-4">
        ...
        <div className="h-[calc(100vh-200px)] bg-gray-100 rounded-xl relative">
          {/* Map will be integrated here */}
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-luxe-400">Map Loading...</p>
          </div>
          
          {/* Example MedSpa Card */}
          <div className="absolute bottom-4 left-4 right-4">
            <motion.div 
              className="bg-white p-4 rounded-xl shadow-lg border border-luxe-200"
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-luxe-900">Luxury MedSpa</h3>
                  <p className="text-sm text-luxe-500">2.5 miles away</p>
                ...
                <motion.button
                  className="px-4 py-2 bg-luxe-500 text-white rounded-lg"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Book
