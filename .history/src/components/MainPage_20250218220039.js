  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-10 px-4 max-w-screen-xl mx-auto">
        ...
        <motion.section className="pb-8 border-b border-[#3E2723]/10">
          <h2 className="cormorant text-2xl mb-6 text-[#3E2723]">Your Skin Profile</h2>
          <p className="text-[#3E2723]/80 text-base font-light leading-relaxed mb-6">
            {getSkinSummary()}
          </p>
          
          <div className="space-y-4">
            <div className="border-b border-[#3E2723]/10 pb-4">
        ...
        <motion.section className="pt-8 pb-8 border-b border-[#3E2723]/10">
          ...
          <div className="overflow-x-auto pb-4">
            <div className="flex space-x-4" style={{ minWidth: 'min-content' }}>
              {treatments.map((treatment, index) => (
                <motion.button
                  key={treatment.id}
                  className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all hover:bg-[#3E2723]/5 flex-shrink-0"
                  style={{ width: '280px' }}
                  onClick={() => handleTreatmentClick(treatment)}
                >
                  <div className="p-4 flex flex-col items-center text-center">
                    <div className="w-32 h-32 mb-3 relative rounded-full overflow-hidden border-2 border-[#3E2723]/10">
                      <img 
                        src={treatment.image} 
                        alt={treatment.name}
