      ...
      >
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-4 mt-6">
            <h2 className="text-lg font-semibold text-luxe-900">Recommended for You</h2>
            {[
              {
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-luxe-900">{doctor.name}</h3>
                    <p className="text-sm text-luxe-600">{doctor.specialty}</p>
        ...
        <div className="p-4 space-y-6">
          <div className="bg-white rounded-xl border border-luxe-200 p-6">
            ...
            <div className="flex gap-4 mb-6">
              ...
              <div className="flex-1">
                <img 
                  src={selectedImage} // Most recent photo
                  alt="Latest Analysis" 
                  className="w-full h-40 object-cover rounded-lg mb-2"
                />
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-luxe-800 mb-2">Key Improvements</h3>
                <ul className="list-disc list-inside space-y-2 text-luxe-600">
                  <li>Skin age reduced by {improvements.skinAge}% (35 to 25 years)</li>
                  <li>Hydration increased by {improvements.hydration}%</li>
                  <li>Texture improved by {improvements.texture}%</li>
                </ul>
              </div>
              
              <div>
                <h3 className="text-lg font-medium text-luxe-800 mb-2">Areas for Improvement</h3>
                <ul className="list-disc list-inside space-y-2 text-luxe-600">
                  <li>Regular pore care needed</li>
                  <li>Enhanced UV protection recommended</li>
                  <li>Maintain current hydration routine</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-medium text-luxe-800 mb-2">Recommended Actions</h3>
                <ul className="list-disc list-inside space-y-2 text-luxe-600">
                  <li>Weekly exfoliation for pore care</li>
                  <li>Daily SPF 50+ application</li>
                  <li>Continue using hyaluronic acid serum</li>
                </ul>
              </div>
            </div>
          </div>
