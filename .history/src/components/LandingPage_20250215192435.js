...
const LandingPage = ({ onStartQuiz }) => {
  return (
    ...
    >
      <ScrollToTop />
      <div className="pt-28 px-12 text-center mb-8">
        <h1 className="cormorant text-2xl text-[#3E2723]">Asentica</h1>
      </div>

      <div className="px-6">
        <h2 className="text-lg text-[#3E2723]/80 leading-relaxed mb-4">
          Find trusted skin clinics, just for you
        </h2>
      </div>
